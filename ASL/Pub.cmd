...
"C:\Program Files (x86)\Google\Chrome\Application\chrome.exe" --incognito --user-data-dir="C://Temp//Chrome dev session" --allow-file-access-from-files "%~dp0ASL Publications.htm"
rd  /s /q "C:\Temp\Chrome dev session"
