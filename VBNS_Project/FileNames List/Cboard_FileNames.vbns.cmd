...
RetVal = Mx.Want.Clipboard_FileList_errhnd
End Function
End Class
End Namespace
...
'    Module subs
'        Sub Main()
'            Dim RetVal = Mx.Want.Clipboard_FileList_errhnd
...
Namespace Mx
    Public Class Want
        Public Shared Sub Clipboard_FileList(ret_message As Strap)
        ...
        End Sub 'Clipboard_FileList

        Public Shared Function Clipboard_FileList_errhnd() As Strap
            Dim stpRET = Strapd()
            Clipboard_FileList_errhnd = stpRET
            stpRET.d("QUIT")
            Dim objERR_LIST = New ErrListBase : Try
                Call Clipboard_FileList(stpRET)
            ...
            End If
        End Function 'Clipboard_FileList_errhnd
    End Class 'Want
